...
func TestVoteSignBytesTestVectors(t *testing.T) {
	...
	tests := []struct {
		...
		0: {
			...
			[]byte{0xa1, 0xb2, 0x3, 0xeb, 0x3d, 0x1a, 0x0, 0x0, 0x9d, 0x90, 0x8e, 0xcf, 0xb6, 0xb2, 0x56, 0xde, 0xf8, 0xb4, 0x9a, 0x7c, 0x50, 0x4e, 0x6c, 0x88, 0x9c, 0x4b, 0xe, 0x41, 0xfe, 0x6c, 0xe3, 0xe0, 0x18, 0x63, 0xdd, 0x7b, 0x61, 0xa2, 0xa, 0xa0},
		},
		// with proper (fixed size) height and round (PreCommit):
		1: {
			"", &Vote{Height: 1, Round: 1, Type: tmproto.PrecommitType},
			[]byte{0xa1, 0xb2, 0x3, 0xeb, 0x3d, 0x1a, 0x0, 0x0, 0x4d, 0xb0, 0x57, 0x6b, 0x7d, 0x1c, 0xa5, 0x85, 0xce, 0x21, 0xae, 0x2a, 0x2d, 0x30, 0x40, 0x72, 0x5e, 0x53, 0xde, 0x5c, 0xd9, 0x13, 0x37, 0x45, 0x96, 0x78, 0x25, 0xab, 0x48, 0x2b, 0xfb, 0x1e},
		},
		// with proper (fixed size) height and round (PreVote):
		2: {
			"", &Vote{Height: 1, Round: 1, Type: tmproto.PrevoteType},
			[]byte{0xa1, 0xb2, 0x3, 0xeb, 0x3d, 0x1a, 0x0, 0x0, 0xf3, 0xdd, 0x2c, 0x58, 0xf4, 0xb5, 0x46, 0x1, 0x8d, 0x9a, 0x5e, 0x14, 0x7e, 0x19, 0x5b, 0x77, 0x44, 0xee, 0xe2, 0x7b, 0x76, 0xca, 0xe2, 0x99, 0xda, 0xd6, 0x3f, 0x22, 0x11, 0x73, 0xcc, 0xa0},
		},
		3: {
			"", &Vote{Height: 1, Round: 1},
			[]byte{0xa1, 0xb2, 0x3, 0xeb, 0x3d, 0x1a, 0x0, 0x0, 0xd7, 0x2a, 0xaf, 0xe4, 0xc3, 0x64, 0x8, 0x33, 0x34, 0xe5, 0x14, 0x7a, 0xe, 0x9, 0x58, 0x3c, 0x53, 0xc2, 0xea, 0x37, 0x68, 0xbc, 0xd9, 0x5, 0xf6, 0xd9, 0x35, 0xf3, 0x57, 0xe9, 0xb8, 0x8f},
		},
