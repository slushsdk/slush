...
func TestVoteSignBytesTestVectors(t *testing.T) {
	...
	tests := []struct {
		...
		4: {
			...
			[]byte{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa1, 0xb2, 0x3, 0xeb, 0x3d, 0x1a, 0x0, 0x0, 0x0, 0x5a, 0x7, 0x2, 0x85, 0xd, 0x49, 0xf9, 0x70, 0x7e, 0xcb, 0xb, 0xd7, 0x57, 0x7e, 0x98, 0x9c, 0xad, 0x28, 0x26, 0x99, 0xb3, 0x39, 0xa1, 0xcb, 0x4, 0x65, 0x10, 0x79, 0xad, 0xc2, 0x4f},
		},
	}
...
func TestVoteString(t *testing.T) {
	...
	expected := `Vote{56789:043138D42EDF 12345/02/SIGNED_MSG_TYPE_PRECOMMIT(Precommit) 03E7A58A7E2D 000000000000 @ 2017-12-25T03:00:01.234Z}`
	if str != expected {
		t.Errorf("got unexpected string for Vote. Expected:\n%v\nGot:\n%v", expected, str)
	}

	str2 := examplePrevote().String()
	expected = `Vote{56789:043138D42EDF 12345/02/SIGNED_MSG_TYPE_PREVOTE(Prevote) 03E7A58A7E2D 000000000000 @ 2017-12-25T03:00:01.234Z}`
	if str2 != expected {
		t.Errorf("got unexpected string for Vote. Expected:\n%v\nGot:\n%v", expected, str2)
	}
}
