...
func TestInvoke(t *testing.T) {
	...
	ext := consensus.FormatExternal(trustedLightBlock, untrustedLightBlock, &validatorSet, big.NewInt(1667583826755686009), big.NewInt(199999999999990), trustingPeriod)
	...
	a := big.NewInt(0)
	b, _ := big.NewInt(0).SetString("347be35996a21f6bf0623e75dbce52baba918ad5ae8d83b6f416045ab22961a", 16)
