...
func test_verifySig{
    ...
    let pubkey = PublicKeyData(
        ecdsa=1628448741648245036800002906075225705100596136133912895015035902954123957052
    );
    ...
    let signature = SignatureData(
        signature_r=1225578735933442828068102633747590437426782890965066746429241472187377583468,
        signature_s=3568809569741913715045370357918125425757114920266578211811626257903121825123,
    );
...
func test_get_total_voting_power{pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (res: felt) {
    ...
    let validator_data0: ValidatorData = ValidatorData(
        Address=0, pub_key=pub_key, voting_power=1, proposer_priority=0
    );
    let validator_data1: ValidatorData = ValidatorData(
        Address=0, pub_key=pub_key, voting_power=2, proposer_priority=0
    );
    let validator_data2: ValidatorData = ValidatorData(
        Address=0, pub_key=pub_key, voting_power=3, proposer_priority=0
    );
