...
func TestSerializeUnit(t *testing.T) {
	...
	testCases := []testCase{
		//single elem tests
		0: {
			description: "single elem *big.Int",
			input:       big.NewInt(1),
			expected:    []*big.Int{big.NewInt(1)},
		},
		1: {
			description:  "single elem not a *big.Int, should return an error",
			input:        1,
			errorMessage: "expected input to be type of *big.Int or a slice, struct containing it, got 'int' instead",
		},
		//slice tests
		2: {
			description: "slice of *big.Int",
			input:       []*big.Int{big.NewInt(132423), big.NewInt(234872364)},
			expected:    []*big.Int{big.NewInt(2), big.NewInt(132423), big.NewInt(234872364)},
		},
		3: {
			description: "slice of slice containing *big.Int",
			input:       [][]*big.Int{{big.NewInt(132423), big.NewInt(234872364)}, {big.NewInt(132423), big.NewInt(234872364)}},
			expected:    []*big.Int{big.NewInt(2), big.NewInt(2), big.NewInt(132423), big.NewInt(234872364), big.NewInt(2), big.NewInt(132423), big.NewInt(234872364)},
		},
		4: {
			description: "slice of struct containing *big.Int",
			input: []struct {
				Val *big.Int
			}{
				{big.NewInt(132423)},
				{big.NewInt(234872364)},
			},
			expected: []*big.Int{big.NewInt(2), big.NewInt(132423), big.NewInt(234872364)},
		},
		5: {
			description:  "slice of something else, should return an error",
			input:        []int{1, 2, 3},
			errorMessage: "expected input to be type of *big.Int or a slice, struct containing it, got 'int' instead",
		},
		6: {
			description:  "slice of slice containing something else, should return an error",
			input:        [][]int{{1, 2, 3}, {1, 2, 3}},
			errorMessage: "expected input to be type of *big.Int or a slice, struct containing it, got 'int' instead",
		},
		7: {
			description: "slice of struct containing something else, should return an error",
			input: []struct {
				Val int
			}{
				{1},
		...
		//struct tests
		8: {
			description: "struct containing *big.Int",
			input: struct {
				Val *big.Int
			}{
				Val: big.NewInt(132423),
			},
			expected: []*big.Int{big.NewInt(132423)},
		},
		9: {
			description: "struct containing slice of *big.Int",
			input: struct {
				Val []*big.Int
			}{
				Val: []*big.Int{big.NewInt(132423), big.NewInt(234872364)},
			},
			expected: []*big.Int{big.NewInt(2), big.NewInt(132423), big.NewInt(234872364)},
		},
		10: {
			description: "struct containing struct containing *big.Int",
			input: struct {
				Val struct {
					Val *big.Int
				}
		...
		11: {
			description: "struct containing something else, should return an error",
			input: struct {
				Val int
			}{
				Val: 1,
		...
		12: {
			description: "struct containing slice of something else, should return an error",
			input: struct {
				Val []int
			}{
				Val: []int{1, 2, 3},
		...
		13: {
			description: "struct containing struct containing something else, should return an error",
			input: struct {
				Val struct {
					Val int
				}
	...
	for i, tc := range testCases {
		t.Run(tc.description, func(t *testing.T) {
			res, err := serialize(tc.input)
			if tc.errorMessage != "" {
				require.ErrorContains(t, err, tc.errorMessage, "test case %d", i)
			} else {
				require.Equal(t, tc.expected, res, "test case %d: %s", i, tc.description)
			}
		})
	}
}

func TestSerializeE2E(t *testing.T) {
	// setup
	trustedLightBlockString := `{"signed_header":{"header":{"version":{"block":"11","app":"1"},"chain_id":"test-chain-IrF74Y","height":"2","time":"2022-11-04T17:43:45.220479Z","last_block_id":{"hash":"038E1EFB6F2C0B4AA1051C0A9B4494B0A7CF34D81C76E6C161B164249A660ABF","parts":{"total":1,"hash":"06A9F404CEC26739C0E7FBDC46DAC64B9151D3A14FA4BB8B4DFD1785D3B14C15"}},"last_commit_hash":"06BE053E669912201CFE99C43884AB9AC38